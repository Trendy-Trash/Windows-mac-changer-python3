...
mac_to_change_to = ["5800E3016527", "0E1122334455", "021122334455", "061122334455"]
...
print(subprocess.run("getmac", capture_output=True).stdout.decode(encoding='iso-8859-1').split('\n'))
print(subprocess.run(["wmic", "nic", "get", "name,index"], capture_output=True).stdout.decode('utf-8', errors="ignore").split('\r\r\n'))
...
while run_last_part:
    ...
    # We recreate the Mac Address as it shows up in getmac XX-XX-XX-XX-XX-XX format
    # from the 12 character string we have.
